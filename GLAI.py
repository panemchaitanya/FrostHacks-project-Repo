...
class CodeRunnerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("S.A.P.P.H.I.R.E")
    ...
    def create_start_interface(self):
        ...
        title_label = ttk.Label(self.root, text="S.A.P.P.H.I.R.E", font=("Arial", 18, "bold"))
    ...
    def show_main_interface(self):
        ...
        self.root.geometry("800x600")  # Increased size
        self.script_names = {
            #"HAND CONTROL": r"C:\Users\shinchan\OneDrive\Documents\IMPACT X\LED Controller\LED Controller\main.py",
            #"VOICE CONTROL": r"C:\Users\shinchan\OneDrive\Documents\IMPACT X\LED Controller (Voice)\LED Controller (Voice)\main.py",
            #"HAND AND VOICE": r"C:\Users\shinchan\OneDrive\Documents\IMPACT X\Merging properties HAND AND VOICE\MAIN.py",
            "VIRTUAL KEYBOARD": r"C:\Users\shinchan\OneDrive\Documents\IMPACT X\Virtual-Keyboard-using-Python-main\Virtual-Keyboard-using-Python-main\WITHALT.py",
            "IKARIS": r"C:\Users\shinchan\OneDrive\Documents\IMPACT X\Virtual mouse using EYE\IKARIS.py",
            "AIR CANVAS": r"C:\Users\shinchan\OneDrive\Documents\IMPACT X\DIGITAL_BOARD_CANVAS\Air-Canvas-with-ML-master\air_canvas_ml.py",
            "VIDEO CONTROL": r"C:\Users\shinchan\OneDrive\Documents\IMPACT X\CRUZZ\CRUZZ.py",
            "VIRTUAL MOUSE": r"C:\Users\shinchan\OneDrive\Documents\IMPACT X\Virtual mouse basic.py"
        }
        ...
        indications_label = ttk.Label(self.root, text="*  Click on the button to run the operation\n"
                                                    ...
                                                    "*  MADE BY  EVANGELION", font=("Times New Roman", 10, "bold"), background="sky blue")
